...
cantidadPaquetes.innerHTML = "<h3>Productos: </h3>";
...
botonFinalizar.onclick = () => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      Swal.fire("Compra confirmada", "¡Gracias por tu preferencia!", "success");
      vaciarCarrito();
    }
  });
};
...
for (const paquete of paquetes) {
  ...
  document.getElementById(`btn${paquete.id}`).onclick = () =>
